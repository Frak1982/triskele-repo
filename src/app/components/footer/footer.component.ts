      ...
      <div class="container">
        <div class="footer-content">
          ...
          <div class="footer-column newsletter">
            <h3 class="footer-title">{{ 'FOOTER.OPENING_HOURS' | translate }}</h3>
            <ul class="contact-info">
              <li>
                <span><strong>{{ 'FOOTER.MONDAY_FRIDAY' | translate }}:</strong> {{ 'FOOTER.HOURS_MON_FRI' | translate }}</span>
              </li>
              <li>
                <span><strong>{{ 'FOOTER.SATURDAY' | translate }}:</strong> {{ 'FOOTER.HOURS_SAT' | translate }}</span>
              </li>
              <li>
                <span><strong>{{ 'FOOTER.SUNDAY' | translate }}:</strong> {{ 'FOOTER.HOURS_SUN' | translate }}</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="map-container">
          <h3 class="footer-title">{{ 'FOOTER.OUR_LOCATION' | translate }}</h3>
...
export class FooterComponent implements OnInit, OnDestroy {
  ...
  private updateMapUrl(): void {
    ...
    const baseUrl = 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d21316.651273938823!2d-1.6949653!3d48.1113387!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x480ede2fa7d69085%3A0x40ca5cd36e4ab30!2sCentro%20citt%C3%A0%2C%20Rennes%2C%20Francia';
