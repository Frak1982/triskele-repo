...
export const TRANSLATIONS = {
  ...
  en: {
    ...
    FOOTER: {
      ...
      AUTHOR: 'Developed by Francesco Raciti',
    ...
    HERO: {
      TITLE: `Good Morning! We are TRISKELE, Italian-Sicilian Gastronomy`,
      SUBTITLE: `Here we cook with heart and welcome you as if you were at home. Sicilian and Italian delights to enjoy with one hand, aromas that awaken memories, and flavors that tell a story.`,
  ...
  fr: {
    ...
    FOOTER: {
      DESCRIPTION: `Fermez les yeux… vous êtes en Italie. Chez TRISKELE, on cuisine avec le coeur et on régale avec des saveurs vraies, maison etgénéreuses.`,
      LINKS: 'Liens',
      HOME: 'Accueil',
      ABOUT: 'À Propos',
      MENU: 'Cart',
      ...
      AUTHOR: 'Développé par Francesco Raciti',
    ...
    HERO: {
      ...
      SUBTITLE: `Ici, on cuisine avec le coeur et on vous accueille comme à la maison. Des gourmandises siciliennes et italiennes à savourer d'une main, des parfums qui réveillent les souvenirs et des saveurs qui racontent une histoire.`,
    ...
    ABOUT: {
      ...
      SUBTITLE: `Triskele, un morceau d'Italie au coeur de Rennes`,
      WHO_WE_ARE: `Qui Sommes-Nous`,
      PARAGRAPH_1: `Triskele, c'est avant tout une histoire de passion et de saveurs. Née de l'amour pour la cuisine italienne authentique et du désir de partager les recettes de famille transmises de génération en génération, notre maison célèbre la richesse des traditions culinaires italiennes.`,
      PARAGRAPH_2: `Installé en plein coeur de Rennes, Triskele vous invite à vivre une expérience gourmande, chaleureuse et conviviale. Ici, chaque plat raconte une histoire, préparée avec des produits frais, des ingrédients de qualité, et des spécialités importées directement d'Italie.`,
      PARAGRAPH_3: `Notre mission ? Vous faire voyager à travers les parfums et les saveurs du Sud, sans quitter Rennes. Offrir un morceau d'Italie à emporter, comme si vous étiez chez nous, en Sicile. Bienvenue chez Triskele. L'Italie comme on l'aime, généreuse, sincère et gourmande.`,
      IMAGE_ALT: `L'Équipe Triskele`,
      VALUES_TITLE: `Nos Valeurs`,
      AUTHENTICITY_TITLE: `Authenticité`,
      AUTHENTICITY_DESC: `Des recettes familiales, des produits soigneusement sélectionnés et des saveurs fidèles à la cuisine italienne et sicilienne d'autrefois.`,
      QUALITY_TITLE: `Qualité`,
      QUALITY_DESC: `Des ingrédients frais, importés directement d'Italie ou choisis chez des producteurs de confiance. Pas de compromis : ici, on cuisine comme à la maison.`,
      CONVIVIALITY_TITLE: `Convivialité`,
      CONVIVIALITY_DESC: `Un lieu simple et accueillant où chacun est reçu comme un ami. Chez nous, on aime les sourires, les échanges et l'esprit de quartier.`,
      TRANSMISSION_TITLE: `Transmission`,
      TRANSMISSION_DESC: `Parce que la cuisine, c'est aussi une mémoire à partager. Nous perpétuons les recettes et les gestes appris de nos parents et grands-parents, pour que cette culture culinaire vive encore et toujours.`,
      GENEROSITY_TITLE: `Générosité`,
      GENEROSITY_DESC: `Des portions gourmandes, des plats réconfortants et une cuisine qui réchauffe le coeur aussi bien que l'appétit. Chaque bouchée raconte une histoire.`,
      TEAM_TITLE: `QUI SOMMES NOUS`,
      CHEF_TITLE: `Alessandro`,
      CHEF_ALT: `Alessandro`,
      CHEF_POSITION: `Le maestro des fourneaux`,
      CHEF_DESC: `Depuis 15 ans, il pétrit, frit et mijote des recettes de famille venues tout droit de Sicile et d'Italie. Passionné et généreux, il prépare chaque plat comme à la maison, avec le goût des souvenirs et l'amour des bonnes choses. Sa mission ? Faire voyager vos papilles avec des saveurs vraies et généreuses.`,
      MANAGER_ALT: `Manager Roberta`,
      MANAGER_POSITION: `L'esprit créatif et digital de Triskele`,
      MANAGER_DESC: `Complice dans la vie et dans l'aventure Triskele, Roberta imagine l'univers de la marque, gère l'image, les réseaux sociaux et toute la partie digitale. De l'idée à l'écran, c'est elle qui donne vie à l'histoire que nous partageons.`,
    ...
    MENU_PAGE: {
      ...
      TITLE: 'NOS SPÉCIALITÉS',
      SUBTITLE: `Ici, la cuisine italo-sicilienne rencontre les recettes régionales italiennes dans un esprit street-food fait maison. Des plats chauds, des douceurs artisanales et des boissons typiques à déguster sur le pouce ou à emporter. Les saveurs du Sud et d'ailleurs, à deux pas de chez vous.`,
      CATEGORIES: {
        TAVOLA_CALDA: 'FAST-GOOD',
        TAVOLA_CALDA_SUBTITLE: `La street-food italo-sicilienne qui réchauffe les coeurs`,
        PRIMI: 'LES GRATINÉS',
    ...
    MENU_ITEMS: {
      TAVOLA_CALDA: {
        ARANCINI: {
          NAME: 'Arancini',
          DESCRIPTION: `Boules de riz croustillantes farcies aux saveurs du Sud. Dorés, fondants et 100% maison.`,
        },
        FOCACCIA: {
          NAME: 'Focacce farcies',
          DESCRIPTION: `Spécialité toscane aux arômes d'huile d'olive, garnies de produits frais et savoureux. Un plaisir croustillant et généreux, venu du coeur de l'Italie.`,
        },
        PIZZA_FRITTA: {
          NAME: 'Pizza Fritta',
        ...
        PIZZA_PORTAFOGLIO: {
          ...
          DESCRIPTION: `La street-food napolitaine par excellence. Une pizza pliée à dévorer sur le pouce, chaude et généreuse.`,
        },
      },
      PRIMI: {
        LASAGNE: {
      ...
      DOLCI: {
        ...
        TIRAMISU: {
          NAME: 'Tiramisù',
          DESCRIPTION: `Le dessert italien incontournable. Crème légère au mascarpone, café intense et cacao amer pour finir en beauté.`,
        },
        GRAFFE: {
          NAME: 'Graffe della nonna',
